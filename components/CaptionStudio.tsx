...
export default function CaptionStudio() {
  ...
  async function transcribe() {
    if (!video) return;
    setBusy(true);
    setStatus("Sending video to Gemini…");
    ...
    try {
      ...
      setStatus(`Done — ${data.segments?.length || 0} caption segments generated by Gemini`);
    } catch (e: any) {
  ...
  return (
    <main>
      ...
      <section className="hero">
        <div>
          <p className="eyebrow">VIDEO → GEMINI AI → CAPTIONS</p>
          <h1>Make every word<br /><span>easy to follow.</span></h1>
          <p className="lead">Upload a video. Gemini understands the video and creates synchronized English subtitles.</p>
        </div>
        <div className="card">
          {!video ? (
            ...
            <>
              ...
              <div className="controls">
                <button className="primary" disabled={busy} onClick={transcribe}>{busy ? "Gemini is processing…" : "Generate captions with Gemini"}</button>
      ...
      <section className="features">
        <div><b>01</b><h3>Gemini transcription</h3><p>Gemini analyzes the uploaded video and creates timestamped English captions.</p></div>
        <div><b>02</b><h3>Live preview</h3><p>Preview your generated captions directly over the video.</p></div>
